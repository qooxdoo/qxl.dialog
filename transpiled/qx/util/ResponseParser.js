    ...
    members: {
      ...
      setParser: function setParser(parser) {
        ...
        if (typeof qx.util.ResponseParser.PARSER[parser] === "function") {
          return this.__P_415_0 = qx.util.ResponseParser.PARSER[parser];
        } // If parser is not a symbol, it must be a function


        return this.__P_415_0 = parser;
      },
...
//# sourceMappingURL=ResponseParser.js.map?dt=1606833973729