  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.placement.Placement", {
    ...
    construct: function construct() {
      ...
      this.__P_425_0 = qx.util.placement.DirectAxis;
    },
    properties: {
      /**
    ...
    statics: {
      ...
      compute: function compute(size, area, target, offsets, position, modeX, modeY) {
        this.__P_425_1 = this.__P_425_1 || new qx.util.placement.Placement();
        var splitted = position.split("-");
        var edge = splitted[0];
        var align = splitted[1];

        this.__P_425_1.set({
          axisX: this.__P_425_2(modeX),
          axisY: this.__P_425_2(modeY),
          edge: edge,
          align: align
        });

        return this.__P_425_1.compute(size, area, target, offsets);
      },
      __P_425_3: null,
      __P_425_4: null,
      __P_425_5: null,
       ...
       */
      __P_425_2: function __P_425_2(mode) {
        switch (mode) {
          case "direct":
            this.__P_425_3 = this.__P_425_3 || qx.util.placement.DirectAxis;
            return this.__P_425_3;

          case "keep-align":
            this.__P_425_4 = this.__P_425_4 || qx.util.placement.KeepAlignAxis;
            return this.__P_425_4;

          case "best-fit":
            this.__P_425_5 = this.__P_425_5 || qx.util.placement.BestFitAxis;
            return this.__P_425_5;
    ...
    members: {
      ...
      compute: function compute(size, area, target, offsets) {
        var axisX = this.getAxisX() || this.__P_425_0;
        ...
        }, area.width, this.__P_425_6());

        var axisY = this.getAxisY() || this.__P_425_0;
...
//# sourceMappingURL=Placement.js.map?dt=1603197368966