  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.EditDistance", {
    statics: {
       ...
       */
      __P_411_0: function __P_411_0(dataA, dataB) {
       ...
       */
      __P_411_1: function __P_411_1(distance, dataA, dataB) {
        var operations = [];
      ...
      getEditOperations: function getEditOperations(dataA, dataB) {
        var distance = this.__P_411_0(dataA, dataB);

        var operations = this.__P_411_1(distance, dataA, dataB);
...
//# sourceMappingURL=EditDistance.js.map?dt=1596028909127