  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Placeholder", {
    statics: {
       ...
       */
      __P_189_0: function __P_189_0(item) {
       ...
       */
      __P_189_1: function __P_189_1(item) {
      ...
      updatePlaceholder: function updatePlaceholder() {
        ...
        if (!qxWeb.env.get("css.placeholder")) {
          for (var i = 0; i < this.length; i++) {
            ...
            if (!placeholderEl) {
              placeholderEl = qx.module.Placeholder.__P_189_1(item);
            ...
            qx.module.Placeholder.__P_189_0(item);
          }
...
//# sourceMappingURL=Placeholder.js.map?dt=1596028887520