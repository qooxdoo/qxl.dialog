  ...
  qx.Class.define("qx.html.Iframe", {
    ...
    */
    ...
    construct: function construct(url, styles, attributes) {
      ...
      this.setSource(url);
      this.addListener("navigate", this.__P_154_0, this); // add yourself to the element queue to enforce the creation of DOM element
...
//# sourceMappingURL=Iframe.js.map?dt=1607450661445