  ...
  qx.Class.define("qx.io.rest.Resource", {
    ...
    members: {
      ...
      map: function map(action, method, url, check) {
        ...
        this.__P_172_4(action, method, url, check);
       ...
       *   <code>qx.io.rest.Resource.REQUIRED</code> (to verify existence).
       */
      __P_172_4: function __P_172_4(action, method, url, check) {
        this.__P_172_2[action] = [method, url, check]; // Undefine generic getter when action is named "get"
        ...
        this.__P_172_5(action + "Success");

        this.__P_172_5(action + "Error");
      ...
      invoke: function invoke(action, params, data) {
        ...
        this.__P_172_2[action].params = params;
      ...
      poll: function poll(action, interval, params, immediately) {
        ...
        if (this.__P_172_1[action]) {
          this.__P_172_1[action].dispose();
        } // Fallback to previous params


        if (typeof params == "undefined") {
          params = this.__P_172_2[action].params;
        } // Invoke immediately
        ...
        var timer = this.__P_172_1[action] = new qx.event.Timer(interval);
      ...
      longPoll: function longPoll(action) {
        ...
        var handlerId = this.__P_172_0[action] = this.addListener(action + "Success", function longPollHandler() {
          if (res.isDisposed()) {
            return;
          }
       ...
       */
      __P_172_3: function __P_172_3(description) {
       ...
       */
      __P_172_5: function __P_172_5(type) {
    ...
    destruct: function destruct() {
      ...
      if (this.__P_172_1) {
        for (action in this.__P_172_1) {
          var timer = this.__P_172_1[action];
          timer.stop();
          timer.dispose();
        }
      }
      ...
      if (this.__P_172_0) {
        for (action in this.__P_172_0) {
          var id = this.__P_172_0[action];
      ...
      this._resource = this.__P_172_2 = this.__P_172_1 = this.__P_172_0 = null;
    }
  });
  qx.io.rest.Resource.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Resource.js.map?dt=1607441413828