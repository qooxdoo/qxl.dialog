    ...
    members: {
      ...
      */
      ...
      _startIframeObserver: function _startIframeObserver() {
        ...
        this.__P_248_1 = idle.addListener("interval", this._onIframeObserverInterval, this);
      },
      ...
      _stopIframeObserver: function _stopIframeObserver() {
        ...
        var idle = qx.event.Idle.getInstance();
        idle.removeListenerById(this.__P_248_1);
      },
      ...
      _onIframeObserverInterval: function _onIframeObserverInterval() {
        ...
        if (this.__P_248_0 && iframeSize.width == this.__P_248_0.width && iframeSize.height == this.__P_248_0.height) {
          return;
        }

        this.__P_248_0 = iframeSize;
...
//# sourceMappingURL=ThemedIframe.js.map?dt=1607008542417