  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__P_232_1[widget.toHashCode()]) {
          delete this.__P_232_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__P_232_0, widget);
        }

        delete this.__P_232_2[widget.toHashCode()];
      },
      ...
      isVisible: function isVisible(widget) {
        return this.__P_232_2[widget.toHashCode()] || false;
      },
       ...
       * @return {Boolean} Whether the widget is visible
       */
      __P_232_3: function __P_232_3(widget) {
        var data = this.__P_232_2;
      ...
      add: function add(widget) {
        ...
        this.__P_232_0.unshift(widget);

        this.__P_232_1[widget.toHashCode()] = widget;
      ...
      flush: function flush() {
        ...
        var data = this.__P_232_2; // Dynamically add children to queue
...
//# sourceMappingURL=Visibility.js.map?dt=1607008541066