  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.renderer.table.cell.Conditional", {
    ...
    construct: function construct(align, color, style, weight) {
      ...
      this.__P_330_0 = ["==", "!=", ">", "<", ">=", "<="];
      this.__P_330_1 = ["between", "!between"];
      this.__P_330_2 = [];
      this.__P_330_3 = align || "";
      this.__P_330_4 = color || "";
      this.__P_330_5 = style || "";
      this.__P_330_6 = weight || "";
    },
    members: {
      __P_330_0: null,
      __P_330_1: null,
       ...
       */
      __P_330_7: function __P_330_7(condition, style) {
        if (condition.align) {
      ...
      addNumericCondition: function addNumericCondition(condition, value1, align, color, style, weight, target) {
        if (!this.__P_330_0.includes(condition) || value1 == null) {
      ...
      addBetweenCondition: function addBetweenCondition(condition, value1, value2, align, color, style, weight, target) {
        if (!this.__P_330_1.includes(condition) || value1 == null || value2 == null) {
      ...
      _getCellStyle: function _getCellStyle(cellInfo) {
        ...
        var compareValue;
        var style = {
          "text-align": this.__P_330_3,
          "color": this.__P_330_4,
          "font-style": this.__P_330_5,
          "font-weight": this.__P_330_6
        };

        for (i = 0; i < this.__P_330_2.length; i++) {
          var test = this.__P_330_2[i];
          bTestPassed = false;

          if (this.__P_330_0.includes(test.condition)) {
            if (test.target == null) {
          ...
          } else if (this.__P_330_1.includes(test.condition)) {
            if (test.target == null) {
              compareValue = cellInfo.cellData;
            } else {
              compareValue = cellInfo.element.data[test.target];
...
//# sourceMappingURL=Conditional.js.map?dt=1603197581439