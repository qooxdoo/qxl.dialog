  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_204_1 || 0,
          height: this.__P_204_2 || 0
        };
      },
      // overridden
      _applyDecorator: function _applyDecorator(value, old) {
        ...
        this.__P_204_8(el, source);
      },
      // overridden
      _applyTextColor: function _applyTextColor(value) {
        if (this.__P_204_9() === "font") {
          var el = this.getContentElement();
      ...
      */
       ...
       */
      __P_204_10: function __P_204_10(mode) {
        this.__P_204_3 = mode;
      },
      ...
      __P_204_9: function __P_204_9() {
        if (this.__P_204_3 == null) {
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_204_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_204_3 = "scaled";
          } else {
            this.__P_204_3 = "nonScaled";
          }
        }
       ...
       */
      __P_204_11: function __P_204_11(mode) {
        var scale;
        var tagName;
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_204_5 = new qx.html.Element("div");
            element.connectWidget(this);
      ...
      __P_204_7: function __P_204_7() {
        ...
        var mode = this.__P_204_9();

        if (this.__P_204_0[mode] == null) {
          this.__P_204_0[mode] = this.__P_204_11(mode);
        }

        var element = this.__P_204_0[mode];

        if (!this.__P_204_4) {
          this.__P_204_4 = element;
        }
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_204_12(element);

          return;
        }

        this.__P_204_13(source);
        ...
        var contentEl = this.__P_204_14(); // Detect if the image registry knows this image


        if (ResourceManager.isFontUri(source)) {
          this.__P_204_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_204_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_204_17(contentEl, source);

          this.__P_204_16();
        } else {
          this.__P_204_18(contentEl, source);
        }
      },
      ...
      __P_204_16: function __P_204_16() {
        ...
        qx.bom.AnimationFrame.request(function (rId) {
          ...
          if (rId === this.__P_204_6) {
            this.fireEvent("loaded");
          } else {
            this.fireEvent("aborted");
          }
        }.bind(this, this.__P_204_6));
      },
       ...
       */
      __P_204_14: function __P_204_14() {
        var contentEl = this.__P_204_4;
       ...
       */
      __P_204_13: qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(source) {
          ...
          if (isFont) {
            this.__P_204_10("font");
          } else if (alphaImageLoader && isPng) {
            if (this.getScale() && this.__P_204_9() != "alphaScaled") {
              this.__P_204_10("alphaScaled");
            } else if (!this.getScale() && this.__P_204_9() != "nonScaled") {
              this.__P_204_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_204_9() != "scaled") {
              this.__P_204_10("scaled");
            } else if (!this.getScale() && this.__P_204_9() != "nonScaled") {
              this.__P_204_10("nonScaled");
            }
          }

          this.__P_204_19(this.__P_204_7());
        },
        "default": function _default(source) {
          ...
          if (isFont) {
            this.__P_204_10("font");
          } else if (this.getScale() && this.__P_204_9() != "scaled") {
            this.__P_204_10("scaled");
          } else if (!this.getScale() && this.__P_204_9() != "nonScaled") {
            this.__P_204_10("nonScaled");
          }
       ...
       */
      __P_204_19: function __P_204_19(elementToAdd) {
        var currentContentElement = this.__P_204_4;
        ...
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_204_5 ? elementToAdd.getChild(0) : elementToAdd;
       ...
       */
      __P_204_15: function __P_204_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          this.__P_204_20(width, height);

          this.__P_204_8(el, source); // Apply source

        } else {
          // Apply source
          this.__P_204_8(el, source); // Compare with old sizes and relayout if necessary


          this.__P_204_20(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
       ...
       * @param source {String} source path
       */
      __P_204_17: function __P_204_17(el, source) {
       ...
       * @param el {Element} image DOM element
       */
      __P_204_12: function __P_204_12(el) {
        if (el != null) {
       ...
       * @param source {String} source path
       */
      __P_204_8: function __P_204_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            el.setStyle("fontSize", (this.__P_204_1 > this.__P_204_2 ? this.__P_204_2 : this.__P_204_1) + "px");
          } else {
       ...
       */
      __P_204_21: function __P_204_21(source, imageInfo) {
        ...
        this.__P_204_17(this.__P_204_14(), source);
      },
       ...
       */
      __P_204_20: function __P_204_20(width, height) {
        // Compare with old sizes and relayout if necessary
        if (width !== this.__P_204_1 || height !== this.__P_204_2) {
          this.__P_204_1 = width;
          this.__P_204_2 = height;
    ...
    */
    destruct: function destruct() {
      for (var mode in this.__P_204_0) {
        if (this.__P_204_0.hasOwnProperty(mode)) {
          this.__P_204_0[mode].disconnectWidget(this);
        }
      }
      ...
      this._disposeMap("__P_204_0");
    }
  });
  qx.ui.basic.Image.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Image.js.map?dt=1606833953406