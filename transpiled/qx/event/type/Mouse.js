          ...
          default:
            if (!(qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") <= 8)) {
              ...
              if (this._native.button === -1) {
                return this.__P_147_1[this._native.buttons] || "none";
              }

              return this.__P_147_0[this._native.button] || "none";
            } else {
              return this.__P_147_2[this._native.button] || "none";
            }
...
//# sourceMappingURL=Mouse.js.map?dt=1596027665659