  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.Messaging", {
    construct: function construct() {
      this._listener = {}, this.__P_119_0 = 0;
      this.__P_119_1 = {};
    },
    members: {
      _listener: null,
      ...
      remove: function remove(id) {
        var channel = this.__P_119_1[id];
        var listener = this._listener[channel];
        delete listener[id];
        delete this.__P_119_1[id];
      },
...
//# sourceMappingURL=Messaging.js.map?dt=1607450658857